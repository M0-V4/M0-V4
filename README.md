# <p align="center">👋 Hi, I'm Miguel Ángel Guardia</p>
  ...
  <tr>
    <td width="50%" valign="top">
      <ul>
        ...
        <li>🎓 <b>Education:</b> Cross-Platform App Development (DAM)</li>
        <li>💻 <b>Focus:</b> Back-end Development</li>
      </ul>
    </td>
    <td width="50%" valign="top">
      <ul>
        <li>🚀 Constantly learning new technologies</li>
        <li>🛠️ Focused on writing clean and efficient code</li>
        <li>📅 Academic Period: 2024 – 2026</li>
      </ul>
    </td>
  </tr>
</table>
